...
const Header = ( {isError, refetch} : HeaderProps ) => {
    ...
    return (
        <header>
            ...
            <div className="select_button_block">
                ...
                <button
                onMouseDown={(e) => e.currentTarget.style.backgroundColor = "#A01131"}
                onMouseUp={(e) => e.currentTarget.style.backgroundColor = "#EB0237"}
                onClick={() => refetch()}
                >
                    Обновить
                    <svg className='refreshIcon' width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
